        ...
        <main className="px-4 pt-6 space-y-6 max-w-md mx-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white/40 backdrop-blur-md border border-white/50 rounded-2xl p-4 space-y-4 shadow-sm">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-white/30">
                <div>
                  <span className={cn(typography.body.md, "font-semibold text-on-surface block")}>Push Notifications</span>
                  <span className={cn(typography.caption.sm, "text-on-surface-variant")}>Browser alerts on this device</span>
                </div>
                <div className="flex items-center gap-4">
                  {pushEnabled && (
                    <button
                      onClick={handleTestPush}
                      className="px-3 py-1 bg-primary/10 text-primary text-xs font-semibold rounded-lg hover:bg-primary/20 transition-colors"
                    >
                      Test
                    </button>
                  )}
