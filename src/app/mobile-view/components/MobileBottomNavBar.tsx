...
export default function MobileBottomNavBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-[110] flex justify-around items-center px-4 pb-6 pt-3 backdrop-blur-3xl border-t border-white/20 shadow-[0_-10px_20px_rgba(70,72,212,0.1)] rounded-t-2xl bg-surface/80">
      ...
      <Link href="/settings" className={`flex flex-col items-center justify-center w-12 h-12 transition-transform ${isSettings ? 'bg-primary/10 text-primary rounded-full shadow-sm scale-110' : 'text-on-surface-variant/70 hover:scale-110 active:text-primary'}`}>
