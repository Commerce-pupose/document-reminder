...
export default function DesktopLoginPage() {
  ...
  return (
    <div className="bg-background text-on-surface flex items-center justify-center min-h-screen relative overflow-hidden w-full">
      ...
      <main className="relative z-10 w-full max-w-[440px] px-5 py-4">
        {/* Header Branding */}
        <div className="flex flex-col items-center mb-8 animate-fade-in-down">
          <div className="w-16 h-16 rounded-2xl bg-primary flex items-center justify-center shadow-lg shadow-primary/20 mb-6">
            <span className="material-symbols-outlined text-white text-4xl">corporate_fare</span>
          </div>
          <h1 className={cn(typography.heading.h1, "text-primary tracking-tighter text-3xl font-extrabold")}>HR Portal</h1>
          <p className={cn(typography.body.lg, "text-on-surface-variant mt-2 font-medium")}>Simplify your workspace</p>
        </div>
